...
function AdminBoardList(props) {
    console.group("AdminBoardList");
    console.log("[Start] AdminBoardList ------------------------------");
    console.log("AdminBoardList [props] : ", props);

    const location = useLocation();
    console.log("AdminBoardList [location] : ", location);
    ...
    const retrieveList = useCallback((srchCnd) => {
        ...
        console.groupEnd("AdminBoardList.retrieveList()");
    ...
    console.log("------------------------------AdminBoardList [End]");
    console.groupEnd("AdminBoardList");
    return (
