...
function AdminBoardEdit(props) {
    console.group("AdminBoardEdit");
    console.log("[Start] AdminBoardEdit ------------------------------");
    console.log("AdminBoardEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
	const checkRef = useRef([]);
	
    console.log("AdminBoardEdit [location] : ", location);
    ...
    console.log("------------------------------AdminBoardEdit [End]");
    console.groupEnd("AdminBoardEdit");
