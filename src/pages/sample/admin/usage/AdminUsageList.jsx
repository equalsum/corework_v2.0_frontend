...
import * as EgovNet from 'api/Fetch';
import URL from 'constants/url';

import { default as EgovLeftNav } from 'components/sample/leftmenu/LeftNavAdmin';
import EgovPaging from 'components/Paging';

//import { itemIdxByPage } from 'utils/calc';

function AdminUsageList(props) {
    console.group("AdminUsageList");
    console.log("[Start] AdminUsageList ------------------------------");
    console.log("AdminUsageList [props] : ", props);

    const location = useLocation();
    console.log("AdminUsageList [location] : ", location);
    ...
    const retrieveList = useCallback((srchCnd) => {
        console.groupCollapsed("AdminUsageList.retrieveList()");
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    const listIdx = 0//itemIdxByPage(resultCnt , currentPageNo, pageSize, index);
        ...
        console.groupEnd("AdminUsageList.retrieveList()");
    },[listTag]);
    ...
    console.log("------------------------------AdminUsageList [End]");
    console.groupEnd("AdminUsageList");
