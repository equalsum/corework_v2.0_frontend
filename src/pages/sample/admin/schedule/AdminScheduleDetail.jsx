...
import EgovAttachFile from 'components/AttachFile';

function AdminScheduleDetail(props) {
    console.group("AdminScheduleDetail");
    console.log("[Start] AdminScheduleDetail ------------------------------");
    console.log("AdminScheduleDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("AdminScheduleDetail [location] : ", location);
    ...
    console.log("------------------------------AdminScheduleDetail [End]");
    console.groupEnd("AdminScheduleDetail");
    return (
