...
function AdminScheduleList(props) {
    console.group("AdminScheduleList");
    console.log("[Start] AdminScheduleList ------------------------------");
    console.log("AdminScheduleList [props] : ", props);
    
    const location = useLocation();
    console.log("AdminScheduleList [location] : ", location);
    ...
    const retrieveList = useCallback((srchcnd) => {
        console.groupCollapsed("AdminScheduleList.retrieveList()");
        ...
        console.groupEnd("AdminScheduleList.retrieveList()");
    },[]);

    const drawCalendar = () => {
        console.groupCollapsed("AdminScheduleList.drawCalendar()");
        ...
        console.groupEnd("AdminScheduleList.drawCalendar()");
    }
    ...
    console.log("------------------------------AdminScheduleList [End]");
    console.groupEnd("AdminScheduleList");
    return (
