...
function AdminScheduleEdit(props) {
    console.group("AdminScheduleEdit");
    console.log("[Start] AdminScheduleEdit ------------------------------");
    console.log("AdminScheduleEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("AdminScheduleEdit [location] : ", location);
    ...
    console.log("------------------------------AdminScheduleEdit [End]");
    console.groupEnd("AdminScheduleEdit");
    return (
