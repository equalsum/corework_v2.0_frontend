...
function AdminPasswordUpdate(props) {
    console.group("AdminPasswordUpdate");
    console.log("[Start] AdminPasswordUpdate ------------------------------");
    console.log("AdminPasswordUpdate [props] : ", props);
    ...
    console.log("------------------------------AdminPasswordUpdate [End]");
    console.groupEnd("AdminPasswordUpdate");
