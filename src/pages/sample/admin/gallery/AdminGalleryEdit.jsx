...
function AdminGalleryEdit(props) {
    console.group("AdminGalleryEdit");
    console.log("------------------------------");
    console.log("AdminGalleryEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("AdminGalleryEdit [location] : ", location);
    ...
    console.groupEnd("AdminGalleryEdit");
