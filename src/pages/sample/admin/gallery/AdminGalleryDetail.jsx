...
function AdminGalleryDetail(props) {
    console.group("AdminGalleryDetail");
    console.log("------------------------------");
    console.log("AdminGalleryDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("AdminGalleryDetail [location] : ", location);
    ...
    console.groupEnd("AdminGalleryDetail");
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_VIEW" id="contents">
                        ...
                        <div className="board_view">
                            ...
                            <ImageGallery boardFiles={boardAttachFiles} />
