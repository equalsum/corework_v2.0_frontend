...
function AdminGalleryList(props) {
    console.group("AdminGalleryList");
    console.log("[Start] AdminGalleryList ------------------------------");
    console.log("AdminGalleryList [props] : ", props);

    const location = useLocation();
    console.log("AdminGalleryList [location] : ", location);
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("AdminGalleryList.retrieveList()");
        ...
        console.groupEnd("AdminGalleryList.retrieveList()");
    },[]);
    ...
    console.log("------------------------------AdminGalleryList [End]");
    console.groupEnd("AdminGalleryList");
    return (
