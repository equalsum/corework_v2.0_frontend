...
function AdminNoticeDetail(props) {
    console.group("AdminNoticeDetail");
    console.log("------------------------------");
    console.log("AdminNoticeDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("AdminNoticeDetail [location] : ", location);
    ...
    console.groupEnd("AdminNoticeDetail");
