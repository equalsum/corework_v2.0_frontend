...
function LoginContent(props) {
    console.group("LoginContent");
    console.log("[Start] LoginContent ------------------------------");
    console.log("LoginContent [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("LoginContent [location] : ", location);
    ...
    const submitFormHandler = (e) => {
        console.log("LoginContent submitFormHandler()");
    ...
    console.log("------------------------------LoginContent [End]");
    console.groupEnd("LoginContent");
